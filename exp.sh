...
./apps/build_disk_index --data_type float --dist_fn cosine --data_path ~/vector_dataset/wiki/base.fbin --index_path_prefix ~/vector_dataset/wiki/diskann_filtered_index_Label20_R64_L200_B15_A1.2 -R 64 --FilteredLbuild 200 -B 15 -M 100 -T 32 --label_file ~/vector_dataset/wiki/labels_20.txt --universal_label 0 -F 0
