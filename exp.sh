...
./orangedb_main -basePath /Users/gauravsehgal/work/vector_index/data/siftsmall -M 64 -K 100 -efConstruction 200 -efSearch 200 -nThreads 16 -numVectors 10000 -alpha 1.0
