...
./build/release/bin/orangedb_main -run benchmarkReclusteringIndex -baseVectorPath /home/centos/orangedb/data/sift10m/base.fvecs -queryVectorPath /home/centos/orangedb/data/sift10m/query.fvecs -groundTruthPath /home/centos/orangedb/data/sift10m/gt.bin -k 100 -numInserts 40 -numVectors 1000000 -megaCentroidSize 100 -miniCentroidSize 500 -newMiniCentroidSize 100 -lambda 0 -numMegaReclusterCentroids 5 -numNewMiniReclusterCentroids 100 -nMegaProbes 3 -nMiniProbes 20 -readFromDisk 0 -storagePath /home/centos/orangedb/data/sift10m/incremental_index.bin
