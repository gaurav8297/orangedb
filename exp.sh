...
./build/release/bin/orangedb_main -run benchmarkClustering -baseVectorPath /home/centos/vector_dataset/wiki/base.fvecs -queryVectorPath /home/centos/orangedb/data/gist/query.fvecs -groundTruthPath /home/centos/orangedb/data/gist/gt.bin -k 100 -numVectors 100000000 -nIter 10 -clusterSize 500 -lambda 0 -nProbes 20
