...
./build/release/bin/orangedb_main -run benchmarkNavix -dataPath /home/centos/orangedb/data/gist/base.fvecs -basePath /home/centos/vector_dataset/gist/bench_data -sels 90,75,50,40,30,20,10,5,3,1 -efS 100,100,100,100,100,100,100,100,100,100 -autoEf 1 -k 100 -M 32 -efConstruction 200 -minRecall 0.950 -maxRecall 0.955 -nThreads 32 -readFromDisk 0 -storagePath /home/centos/orangedb/data/gist/navix_index.bin -useIp 0 -resultPath /home/centos/results/gist/

./build/release/bin/orangedb_main -run generateFilterGT -dataPath /home/centos/orangedb/data/wiki/base.fvecs -basePath /home/centos/vector_dataset/wiki/uncorrelated -sels 100,90,75,50,40,30,20,10,5,3,1 -k 100
