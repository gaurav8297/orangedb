...
./build/release/bin/orangedb_main -run benchmarkNavix -dataPath /home/centos/vector_dataset/wiki/base.fvecs -basePath /home/centos/vector_dataset/wiki/uncorrelated -sels 90,75,50,40,30,20,10,5,3,1 -efS 100,100,100,100,100,100,100,100,100,100 -autoEf 1 -k 100 -M 32 -efConstruction 200 -minRecall 0.950 -maxRecall 0.955 -nThreads 32 -readFromDisk 1 -storagePath /home/centos/vector_dataset/wiki/navix_index.bin -useIp 1 -resultPath /home/centos/results/wiki/uncorrelated/
...
## Filtered Benchmark
./apps/utils/generate_synthetic_labels --num_labels 5000 --num_points 15435516 --output_file ~/vector_dataset/wiki/labels.txt --distribution_type zipf
