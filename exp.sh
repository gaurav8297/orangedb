...
./orangedb_main -basePath /home/g3sehgal/vector_index/vector_index/data/siftsmall -M 64 -K 100 -efConstruction 200 -efSearch 200 -nThreads 16 -numVectors 10000 -alpha 1.0 -nCentroids 10 -nIter 30 -minCentroidSize 50000 -maxCentroidSize 50000 -maxSearchCentroids 3 -searchThreshold 0.5 -deletePercent 0.05
